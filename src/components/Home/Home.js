...
function Home() {
  ...
  return (
    <div className="home-page ">
      <div className="page-footer  btns pt-3"></div>
      <div className="main-image position-relative">
        <div className="position-absolute top-50 start-50 translate-middle">
          <p className="pet-img-text container ">
            Where Hearts and Paws Unite!
          </p>
        </div>
        <div className="text-center position-absolute top-100 start-50 translate-middle container">
          <button
            onClick={() => navigate("/pets/filter/dogs")}
            type="button"
          ...
          <button
            onClick={() => navigate("/pets/filter/cats")}
            type="button"
            className="round mx-3 btn-lg"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="1em"
